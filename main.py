...
def attack(char_name: str, char_class: str) -> str:
    """Calculate damage dealt by the character."""
...
def defence(char_name: str, char_class: str) -> str:
    """Calculate damage that the character can block."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Start training for the character: attack, defence or special skill."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Choose class for the new character."""
    approve_choice: str = ''
    char_class: str = ''
